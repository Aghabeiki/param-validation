...
describe('#BaseValidatorPrivateZone', () => {
    ...
    describe('#matchRequirement', () => {
        ...
        it('-Should reject \t missed required params. ', () => {
            let res = BaseValidatorPrivateZone.matchRequirement({
                testParam: {
                    type: 'string',
                    length: 3
                }
    ...
    describe('#matchFieldsDataType', () => {
        it('-should pass in required path.\t multi type param.', () => {
            let res = BaseValidatorPrivateZone.matchFieldsDataType({
                testParam: {
                    type: 'string|number',
                    length: 4
                }
        ...
        it('-should throw an error in required path.\t multi type param, String and Date should not match together.', (done) => {
            let error = null;
            try {
        ...
        it('-should throw an error in non-required path.\t multi type param, String and Date should not match together.', (done) => {
            let error = null;
            try {
                BaseValidatorPrivateZone.matchFieldsDataType({
                    testParam: {
        ...
        it('-should throw an Internal Error\t pass invalid cmd and target params', (done) => {
            ...
            try {
                ...
                done(new Error("The test dose not throw any error."));
            }
            catch (err) {
                error = err;
            }
                ...
                if (error instanceof PVError) {
                    ...
                    error.getDetails().should.have.properties({
                        message: "A problem in validator-logic bank configuration,in compareWithFiled, the format should be something like [cmd]:[field].",
                        data: {
    ...
    describe('#paramConfigChecker', () => {
        ...
        it('-Should throw Internal Error\t invalid Array configuration.', (done) => {
            ...
            try {
                ...
                done(new Error("Test dose not throw error."));
            }
            catch (err) {
                error = err;
            }
        ...
        it('-Should pass\t with correct array config.', () => {
            let res = BaseValidatorPrivateZone.paramConfigChecker({
                type: 'array',
                rows: {
                    type: 'string'
                }
        ...
        it('-should throw Internal Error \t invalid configuration for Object data type.', done => {
            ...
            try {
                ...
                done(new Error('The test dose not throw an Error.'));
            }
            catch (err) {
                error = err;
            }
        ...
        it('-should throw an error\t because of invalid Data Type', done => {
            ...
            try {
                ...
                done(new Error('The test should throw an Error.'));
            }
            catch (err) {
                error = err;
            }
